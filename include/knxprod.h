...
#define MAIN_FirmwareName "SEN-UP1-8xTH"
...
#define THP_ParamBlockOffset 46
...
//    bei Überschreiten von
#define ParamTHP_SensorHumidityWarnH_                (knx.paramFloat(THP_ParamCalcIndex(THP_SensorHumidityWarnH_), Float_Enc_IEEE754Single))
// Min/Max Werte erfassen
...
// deprecated
#define THP_KoOffset 20

// Communication objects per channel (multiple occurrence)
#define THP_KoBlockOffset 20
#define THP_KoBlockSize 32

#define THP_KoCalcNumber(index) (index + THP_KoBlockOffset + _channelIndex * THP_KoBlockSize)
#define THP_KoCalcIndex(number) ((number >= THP_KoCalcNumber(0) && number < THP_KoCalcNumber(THP_KoBlockSize)) ? (number - THP_KoBlockOffset) % THP_KoBlockSize : -1)
#define THP_KoCalcChannel(number) ((number >= THP_KoBlockOffset && number < THP_KoBlockOffset + THP_ChannelCount * THP_KoBlockSize) ? (number - THP_KoBlockOffset) / THP_KoBlockSize : -1)

#define THP_KoSensorTemp_ 0
#define THP_KoSensorTempAlarmL_ 1
#define THP_KoSensorTempAlarmH_ 2
#define THP_KoSensorTempMinValue_ 3
#define THP_KoSensorTempMaxValue_ 4
#define THP_KoSensorTempMinMaxReset_ 5
#define THP_KoSensorHum_ 6
#define THP_KoSensorHumAlarmL_ 7
#define THP_KoSensorHumAlarmH_ 8
#define THP_KoSensorHumMinValue_ 9
#define THP_KoSensorHumMaxValue_ 10
#define THP_KoSensorHumMinMaxReset_ 11
#define THP_KoSensorAbsHum_ 12
#define THP_KoSensorAbsHumAlarmL_ 13
#define THP_KoSensorAbsHumAlarmH_ 14
#define THP_KoSensorAbsHumMinValue_ 15
#define THP_KoSensorAbsHumMaxValue_ 16
#define THP_KoSensorAbsHumMinMaxReset_ 17
#define THP_KoSensorDewPoint_ 18
#define THP_KoSensorDewPointAlarmL_ 19
#define THP_KoSensorDewPointAlarmH_ 20
#define THP_KoSensorDewPointMinValue_ 21
#define THP_KoSensorDewPointMaxValue_ 22
#define THP_KoSensorDewPointMinMaxReset_ 23
#define THP_KoSensorPress_ 24
#define THP_KoSensorPressAlarmL_ 25
#define THP_KoSensorPressAlarmH_ 26
#define THP_KoSensorPressMinValue_ 27
#define THP_KoSensorPressMaxValue_ 28
#define THP_KoSensorPressMinMaxReset_ 29
#define THP_KoInput0_ 30
#define THP_KoInput1_ 31

// Temperatur
#define KoTHP_SensorTemp_                         (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorTemp_)))
// Alarm Temperaturunterschreitung
#define KoTHP_SensorTempAlarmL_                   (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorTempAlarmL_)))
// Alarm Temperaturüberschreitung
#define KoTHP_SensorTempAlarmH_                   (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorTempAlarmH_)))
// Min. Temperatur lesen
#define KoTHP_SensorTempMinValue_                 (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorTempMinValue_)))
// Max. Temperatur lesen
#define KoTHP_SensorTempMaxValue_                 (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorTempMaxValue_)))
// Min/Max Temperatur Reset
#define KoTHP_SensorTempMinMaxReset_              (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorTempMinMaxReset_)))
// Luftfeuchte
#define KoTHP_SensorHum_                          (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorHum_)))
// Alarm Luftfeuchteunterschreitung
#define KoTHP_SensorHumAlarmL_                    (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorHumAlarmL_)))
// Alarm Luftfeuchteüberschreitung
#define KoTHP_SensorHumAlarmH_                    (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorHumAlarmH_)))
// Min. Luftfeuchte lesen
#define KoTHP_SensorHumMinValue_                  (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorHumMinValue_)))
// Max. Luftfeuchte lesen
#define KoTHP_SensorHumMaxValue_                  (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorHumMaxValue_)))
// Min/Max Luftfeuchte Reset
#define KoTHP_SensorHumMinMaxReset_               (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorHumMinMaxReset_)))
// Abs. Luftfeuchte
#define KoTHP_SensorAbsHum_                       (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorAbsHum_)))
// Alarm Abs. Luftfeuchteunterschreitung
#define KoTHP_SensorAbsHumAlarmL_                 (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorAbsHumAlarmL_)))
// Alarm Abs. Luftfeuchteüberschreitung
#define KoTHP_SensorAbsHumAlarmH_                 (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorAbsHumAlarmH_)))
// Min. Abs. Luftfeuchte lesen
#define KoTHP_SensorAbsHumMinValue_               (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorAbsHumMinValue_)))
// Max. Abs. Luftfeuchte lesen
#define KoTHP_SensorAbsHumMaxValue_               (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorAbsHumMaxValue_)))
// Min/Max Abs. Luftfeuchte Reset
#define KoTHP_SensorAbsHumMinMaxReset_            (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorAbsHumMinMaxReset_)))
// Taupunkt
#define KoTHP_SensorDewPoint_                     (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorDewPoint_)))
// Alarm Taupunktunterschreitung
#define KoTHP_SensorDewPointAlarmL_               (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorDewPointAlarmL_)))
// Alarm Taupunktüberschreitung
#define KoTHP_SensorDewPointAlarmH_               (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorDewPointAlarmH_)))
// Min. Taupunkt lesen
#define KoTHP_SensorDewPointMinValue_             (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorDewPointMinValue_)))
// Max. Taupunkt lesen
#define KoTHP_SensorDewPointMaxValue_             (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorDewPointMaxValue_)))
// Min/Max Taupunkt Reset
#define KoTHP_SensorDewPointMinMaxReset_          (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorDewPointMinMaxReset_)))
// Luftdruck
#define KoTHP_SensorPress_                        (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorPress_)))
// Alarm Luftdruckunterschreitung
#define KoTHP_SensorPressAlarmL_                  (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorPressAlarmL_)))
// Alarm Luftdrucküberschreitung
#define KoTHP_SensorPressAlarmH_                  (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorPressAlarmH_)))
// Min. Luftdruck lesen
#define KoTHP_SensorPressMinValue_                (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorPressMinValue_)))
// Max. Luftdruck lesen
#define KoTHP_SensorPressMaxValue_                (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorPressMaxValue_)))
// Min/Max Luftdruck Reset
#define KoTHP_SensorPressMinMaxReset_             (knx.getGroupObject(THP_KoCalcNumber(THP_KoSensorPressMinMaxReset_)))
// Binäreingang 1
#define KoTHP_Input0_                             (knx.getGroupObject(THP_KoCalcNumber(THP_KoInput0_)))
// Binäreingang 2
#define KoTHP_Input1_                             (knx.getGroupObject(THP_KoCalcNumber(THP_KoInput1_)))

#define BTN_ReactionTimeMultiClick              782      // 8 Bits, Bit 7-0
#define BTN_ReactionTimeLong                    783      // 8 Bits, Bit 7-0
#define BTN_ReactionTimeExtraLong               784      // 8 Bits, Bit 7-0
#define BTN_VisibleChannels                     785      // uint8_t
...
// Parameter per channel
#define BTN_ParamBlockOffset 786
...
// deprecated
#define BTN_KoOffset 380

// Communication objects per channel (multiple occurrence)
#define BTN_KoBlockOffset 380
...
#define LOG_BuzzerInstalled                     1634      // 1 Bit, Bit 7
#define     LOG_BuzzerInstalledMask 0x80
#define     LOG_BuzzerInstalledShift 7
#define LOG_LedInstalled                        1634      // 1 Bit, Bit 6
#define     LOG_LedInstalledMask 0x40
#define     LOG_LedInstalledShift 6
#define LOG_VacationKo                          1634      // 1 Bit, Bit 5
#define     LOG_VacationKoMask 0x20
#define     LOG_VacationKoShift 5
#define LOG_HolidayKo                           1634      // 1 Bit, Bit 4
#define     LOG_HolidayKoMask 0x10
#define     LOG_HolidayKoShift 4
#define LOG_VacationRead                        1634      // 1 Bit, Bit 3
#define     LOG_VacationReadMask 0x08
#define     LOG_VacationReadShift 3
#define LOG_HolidaySend                         1634      // 1 Bit, Bit 2
#define     LOG_HolidaySendMask 0x04
#define     LOG_HolidaySendShift 2
#define LOG_Neujahr                             1635      // 1 Bit, Bit 7
#define     LOG_NeujahrMask 0x80
#define     LOG_NeujahrShift 7
#define LOG_DreiKoenige                         1635      // 1 Bit, Bit 6
#define     LOG_DreiKoenigeMask 0x40
#define     LOG_DreiKoenigeShift 6
#define LOG_Weiberfastnacht                     1635      // 1 Bit, Bit 5
#define     LOG_WeiberfastnachtMask 0x20
#define     LOG_WeiberfastnachtShift 5
#define LOG_Rosenmontag                         1635      // 1 Bit, Bit 4
#define     LOG_RosenmontagMask 0x10
#define     LOG_RosenmontagShift 4
#define LOG_Fastnachtsdienstag                  1635      // 1 Bit, Bit 3
#define     LOG_FastnachtsdienstagMask 0x08
#define     LOG_FastnachtsdienstagShift 3
#define LOG_Aschermittwoch                      1635      // 1 Bit, Bit 2
#define     LOG_AschermittwochMask 0x04
#define     LOG_AschermittwochShift 2
#define LOG_Frauentag                           1635      // 1 Bit, Bit 1
#define     LOG_FrauentagMask 0x02
#define     LOG_FrauentagShift 1
#define LOG_Gruendonnerstag                     1635      // 1 Bit, Bit 0
#define     LOG_GruendonnerstagMask 0x01
#define     LOG_GruendonnerstagShift 0
#define LOG_Karfreitag                          1636      // 1 Bit, Bit 7
#define     LOG_KarfreitagMask 0x80
#define     LOG_KarfreitagShift 7
#define LOG_Ostersonntag                        1636      // 1 Bit, Bit 6
#define     LOG_OstersonntagMask 0x40
#define     LOG_OstersonntagShift 6
#define LOG_Ostermontag                         1636      // 1 Bit, Bit 5
#define     LOG_OstermontagMask 0x20
#define     LOG_OstermontagShift 5
#define LOG_TagDerArbeit                        1636      // 1 Bit, Bit 4
#define     LOG_TagDerArbeitMask 0x10
#define     LOG_TagDerArbeitShift 4
#define LOG_Himmelfahrt                         1636      // 1 Bit, Bit 3
#define     LOG_HimmelfahrtMask 0x08
#define     LOG_HimmelfahrtShift 3
#define LOG_Pfingstsonntag                      1636      // 1 Bit, Bit 2
#define     LOG_PfingstsonntagMask 0x04
#define     LOG_PfingstsonntagShift 2
#define LOG_Pfingstmontag                       1636      // 1 Bit, Bit 1
#define     LOG_PfingstmontagMask 0x02
#define     LOG_PfingstmontagShift 1
#define LOG_Fronleichnam                        1636      // 1 Bit, Bit 0
#define     LOG_FronleichnamMask 0x01
#define     LOG_FronleichnamShift 0
#define LOG_Friedensfest                        1637      // 1 Bit, Bit 7
#define     LOG_FriedensfestMask 0x80
#define     LOG_FriedensfestShift 7
#define LOG_MariaHimmelfahrt                    1637      // 1 Bit, Bit 6
#define     LOG_MariaHimmelfahrtMask 0x40
#define     LOG_MariaHimmelfahrtShift 6
#define LOG_DeutscheEinheit                     1637      // 1 Bit, Bit 5
#define     LOG_DeutscheEinheitMask 0x20
#define     LOG_DeutscheEinheitShift 5
#define LOG_Reformationstag                     1637      // 1 Bit, Bit 4
#define     LOG_ReformationstagMask 0x10
#define     LOG_ReformationstagShift 4
#define LOG_Allerheiligen                       1637      // 1 Bit, Bit 3
#define     LOG_AllerheiligenMask 0x08
#define     LOG_AllerheiligenShift 3
#define LOG_BussBettag                          1637      // 1 Bit, Bit 2
#define     LOG_BussBettagMask 0x04
#define     LOG_BussBettagShift 2
#define LOG_Advent1                             1637      // 1 Bit, Bit 1
#define     LOG_Advent1Mask 0x02
#define     LOG_Advent1Shift 1
#define LOG_Advent2                             1637      // 1 Bit, Bit 0
#define     LOG_Advent2Mask 0x01
#define     LOG_Advent2Shift 0
#define LOG_Advent3                             1638      // 1 Bit, Bit 7
#define     LOG_Advent3Mask 0x80
#define     LOG_Advent3Shift 7
#define LOG_Advent4                             1638      // 1 Bit, Bit 6
#define     LOG_Advent4Mask 0x40
#define     LOG_Advent4Shift 6
#define LOG_Heiligabend                         1638      // 1 Bit, Bit 5
#define     LOG_HeiligabendMask 0x20
#define     LOG_HeiligabendShift 5
#define LOG_Weihnachtstag1                      1638      // 1 Bit, Bit 4
#define     LOG_Weihnachtstag1Mask 0x10
#define     LOG_Weihnachtstag1Shift 4
#define LOG_Weihnachtstag2                      1638      // 1 Bit, Bit 3
#define     LOG_Weihnachtstag2Mask 0x08
#define     LOG_Weihnachtstag2Shift 3
#define LOG_Silvester                           1638      // 1 Bit, Bit 2
#define     LOG_SilvesterMask 0x04
#define     LOG_SilvesterShift 2
#define LOG_Nationalfeiertag                    1638      // 1 Bit, Bit 1
#define     LOG_NationalfeiertagMask 0x02
#define     LOG_NationalfeiertagShift 1
#define LOG_MariaEmpfaengnis                    1638      // 1 Bit, Bit 0
#define     LOG_MariaEmpfaengnisMask 0x01
#define     LOG_MariaEmpfaengnisShift 0
#define LOG_NationalfeiertagSchweiz             1639      // 1 Bit, Bit 7
#define     LOG_NationalfeiertagSchweizMask 0x80
#define     LOG_NationalfeiertagSchweizShift 7
#define LOG_Totensonntag                        1639      // 1 Bit, Bit 6
#define     LOG_TotensonntagMask 0x40
#define     LOG_TotensonntagShift 6
#define LOG_BuzzerSilent                        1640      // uint16_t
#define LOG_BuzzerNormal                        1642      // uint16_t
#define LOG_BuzzerLoud                          1644      // uint16_t
#define LOG_VisibleChannels                     1646      // uint8_t
#define LOG_LedMapping                          1647      // 3 Bits, Bit 7-5
#define     LOG_LedMappingMask 0xE0
#define     LOG_LedMappingShift 5
#define LOG_UserFormula1                        1648      // char*, 99 Byte
#define LOG_UserFormula1Active                  1747      // 1 Bit, Bit 7
#define     LOG_UserFormula1ActiveMask 0x80
#define     LOG_UserFormula1ActiveShift 7
#define LOG_UserFormula2                        1748      // char*, 99 Byte
#define LOG_UserFormula2Active                  1847      // 1 Bit, Bit 7
#define     LOG_UserFormula2ActiveMask 0x80
#define     LOG_UserFormula2ActiveShift 7
#define LOG_UserFormula3                        1848      // char*, 99 Byte
#define LOG_UserFormula3Active                  1947      // 1 Bit, Bit 7
#define     LOG_UserFormula3ActiveMask 0x80
#define     LOG_UserFormula3ActiveShift 7
#define LOG_UserFormula4                        1948      // char*, 99 Byte
#define LOG_UserFormula4Active                  2047      // 1 Bit, Bit 7
#define     LOG_UserFormula4ActiveMask 0x80
#define     LOG_UserFormula4ActiveShift 7
#define LOG_UserFormula5                        2048      // char*, 99 Byte
#define LOG_UserFormula5Active                  2147      // 1 Bit, Bit 7
#define     LOG_UserFormula5ActiveMask 0x80
#define     LOG_UserFormula5ActiveShift 7
#define LOG_UserFormula6                        2148      // char*, 99 Byte
#define LOG_UserFormula6Active                  2247      // 1 Bit, Bit 7
#define     LOG_UserFormula6ActiveMask 0x80
#define     LOG_UserFormula6ActiveShift 7
#define LOG_UserFormula7                        2248      // char*, 99 Byte
#define LOG_UserFormula7Active                  2347      // 1 Bit, Bit 7
#define     LOG_UserFormula7ActiveMask 0x80
#define     LOG_UserFormula7ActiveShift 7
#define LOG_UserFormula8                        2348      // char*, 99 Byte
#define LOG_UserFormula8Active                  2447      // 1 Bit, Bit 7
#define     LOG_UserFormula8ActiveMask 0x80
#define     LOG_UserFormula8ActiveShift 7
#define LOG_UserFormula9                        2448      // char*, 99 Byte
#define LOG_UserFormula9Active                  2547      // 1 Bit, Bit 7
#define     LOG_UserFormula9ActiveMask 0x80
#define     LOG_UserFormula9ActiveShift 7
#define LOG_UserFormula10                       2548      // char*, 99 Byte
#define LOG_UserFormula10Active                 2647      // 1 Bit, Bit 7
#define     LOG_UserFormula10ActiveMask 0x80
#define     LOG_UserFormula10ActiveShift 7
#define LOG_UserFormula11                       2648      // char*, 99 Byte
#define LOG_UserFormula11Active                 2747      // 1 Bit, Bit 7
#define     LOG_UserFormula11ActiveMask 0x80
#define     LOG_UserFormula11ActiveShift 7
#define LOG_UserFormula12                       2748      // char*, 99 Byte
#define LOG_UserFormula12Active                 2847      // 1 Bit, Bit 7
#define     LOG_UserFormula12ActiveMask 0x80
#define     LOG_UserFormula12ActiveShift 7
#define LOG_UserFormula13                       2848      // char*, 99 Byte
#define LOG_UserFormula13Active                 2947      // 1 Bit, Bit 7
#define     LOG_UserFormula13ActiveMask 0x80
#define     LOG_UserFormula13ActiveShift 7
#define LOG_UserFormula14                       2948      // char*, 99 Byte
#define LOG_UserFormula14Active                 3047      // 1 Bit, Bit 7
#define     LOG_UserFormula14ActiveMask 0x80
#define     LOG_UserFormula14ActiveShift 7
#define LOG_UserFormula15                       3048      // char*, 99 Byte
#define LOG_UserFormula15Active                 3147      // 1 Bit, Bit 7
#define     LOG_UserFormula15ActiveMask 0x80
#define     LOG_UserFormula15ActiveShift 7
#define LOG_UserFormula16                       3148      // char*, 99 Byte
#define LOG_UserFormula16Active                 3247      // 1 Bit, Bit 7
#define     LOG_UserFormula16ActiveMask 0x80
#define     LOG_UserFormula16ActiveShift 7
#define LOG_UserFormula17                       3248      // char*, 99 Byte
#define LOG_UserFormula17Active                 3347      // 1 Bit, Bit 7
#define     LOG_UserFormula17ActiveMask 0x80
#define     LOG_UserFormula17ActiveShift 7
#define LOG_UserFormula18                       3348      // char*, 99 Byte
#define LOG_UserFormula18Active                 3447      // 1 Bit, Bit 7
#define     LOG_UserFormula18ActiveMask 0x80
#define     LOG_UserFormula18ActiveShift 7
#define LOG_UserFormula19                       3448      // char*, 99 Byte
#define LOG_UserFormula19Active                 3547      // 1 Bit, Bit 7
#define     LOG_UserFormula19ActiveMask 0x80
#define     LOG_UserFormula19ActiveShift 7
#define LOG_UserFormula20                       3548      // char*, 99 Byte
#define LOG_UserFormula20Active                 3647      // 1 Bit, Bit 7
#define     LOG_UserFormula20ActiveMask 0x80
#define     LOG_UserFormula20ActiveShift 7
#define LOG_UserFormula21                       3648      // char*, 99 Byte
#define LOG_UserFormula21Active                 3747      // 1 Bit, Bit 7
#define     LOG_UserFormula21ActiveMask 0x80
#define     LOG_UserFormula21ActiveShift 7
#define LOG_UserFormula22                       3748      // char*, 99 Byte
#define LOG_UserFormula22Active                 3847      // 1 Bit, Bit 7
#define     LOG_UserFormula22ActiveMask 0x80
#define     LOG_UserFormula22ActiveShift 7
#define LOG_UserFormula23                       3848      // char*, 99 Byte
#define LOG_UserFormula23Active                 3947      // 1 Bit, Bit 7
#define     LOG_UserFormula23ActiveMask 0x80
#define     LOG_UserFormula23ActiveShift 7
#define LOG_UserFormula24                       3948      // char*, 99 Byte
#define LOG_UserFormula24Active                 4047      // 1 Bit, Bit 7
#define     LOG_UserFormula24ActiveMask 0x80
#define     LOG_UserFormula24ActiveShift 7
#define LOG_UserFormula25                       4048      // char*, 99 Byte
#define LOG_UserFormula25Active                 4147      // 1 Bit, Bit 7
#define     LOG_UserFormula25ActiveMask 0x80
#define     LOG_UserFormula25ActiveShift 7
#define LOG_UserFormula26                       4148      // char*, 99 Byte
#define LOG_UserFormula26Active                 4247      // 1 Bit, Bit 7
#define     LOG_UserFormula26ActiveMask 0x80
#define     LOG_UserFormula26ActiveShift 7
#define LOG_UserFormula27                       4248      // char*, 99 Byte
#define LOG_UserFormula27Active                 4347      // 1 Bit, Bit 7
#define     LOG_UserFormula27ActiveMask 0x80
#define     LOG_UserFormula27ActiveShift 7
#define LOG_UserFormula28                       4348      // char*, 99 Byte
#define LOG_UserFormula28Active                 4447      // 1 Bit, Bit 7
#define     LOG_UserFormula28ActiveMask 0x80
#define     LOG_UserFormula28ActiveShift 7
#define LOG_UserFormula29                       4448      // char*, 99 Byte
#define LOG_UserFormula29Active                 4547      // 1 Bit, Bit 7
#define     LOG_UserFormula29ActiveMask 0x80
#define     LOG_UserFormula29ActiveShift 7
#define LOG_UserFormula30                       4548      // char*, 99 Byte
#define LOG_UserFormula30Active                 4647      // 1 Bit, Bit 7
...
// Parameter per channel
#define LOG_ParamBlockOffset 4648
...
// deprecated
#define LOG_KoOffset 280

// Communication objects per channel (multiple occurrence)
#define LOG_KoBlockOffset 280
...
#define BASE_KommentarModuleParamOffset 7198
